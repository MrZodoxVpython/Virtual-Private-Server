...
# Tokomard-X-BenjaminWickman-Dev
        ...
        "clients": [
            {
              "id": "${uuid1}",
              "flow": "xtls-rprx-direct",
              "email": "vlessMKCPwgTLS@XRAYbyBenjaminWickman"             
            }
        ],
        "decryption": "none",
        "fallbacks": [
  ...
  "inbounds": [
    {
      ...
      "settings": {
        "clients": [
          {
            "id": "${uuid1}",
            "email": "vlessWSTLS@XRAYbyBenjamin"
          }
        ],
        "decryption": "none"
      },
    ...
    "inbounds": [
        {
            ...
            "settings": {
                "clients": [
                    {
                        "password": "${uuid1}",
                        "email": "trojanGRPC@XRAYbyWickman"
                    }
                ],
                "fallbacks": [
                    {
  ...
  "inbounds": [
    {
      ...
      "settings": {
        "clients": [
          {
            "password": "${uuid1}",
            "email": "trojanTCP@XRAYbyBenjamin"
          }
        ],
        "fallbacks": [
          {
  ...
  "inbounds": [
    {
      ...
      "settings": {
        "clients": [
            {
                "id": "${uuid1}",
                "email": "vmessHTTPTLS@XRAYbyZodox"                
            }
        ]
      },
      "streamSettings": {
  ...
  "inbounds": [
    {
      ...
      "settings": {
        "clients": [
            {
                "id": "${uuid1}",
                "email": "vmessTCPTLS@XRAYbyMrZodox"                
            }
        ]
      },
      "streamSettings": {
        ...
        "clients": [
          {
            "id": "${uuid1}",
            "add": "$domain",
            "email": "vmessWSNONE@XRAYbyBenjamin" 
          }
        ],
        "decryption": "none"
      },
        ...
        "clients": [
          {
            "id": "${uuid1}",
            "add": "$domain",
            "email": "vlessGRPC@XRAYbyMrZodoxVpython" 
          }
        ],
        "decryption": "none"
      },
        ...
        "clients": [
            {
              "password": "${uuid1}",
              "method": "aes-128-gcm",
              "email": "aes-128-gcm@XRAYbyBenjaminWickman"             
            },
            {
              "password": "${uuid1}",
              "method": "aes-256-gcm",
              "email": "aes-256-gcm@XRAYbyMrZodox"                 
            },
            {
              "password": "${uuid1}",
              "method": "chacha20-poly1305",
              "email": "chacha20-poly1305@XRAYbyBenjamin"                 
            }
        ],
        "network": "tcp,udp"
      }
...
[Unit]
Description=Xray Service BENJAMINWICKMAN-DEV
...
[Unit]
Description=Trojan-Go Service BENJAMINWICKMAN-DEV
Documentation=tokomard.store
After=network.target nss-lookup.target
