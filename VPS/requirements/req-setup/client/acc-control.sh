...
MrZodoxVpython="/etc/xray/auto-locked.sh"
...
EOF
  ...
  echo "✅ Cron job terpasang."
    ...
    echo "Memasang script Benjamin.Wickman di /etc/xray/auto-locked.sh"
  cat <<EOF > "$MrZodoxVpython"
#!/bin/bash
#======================++++=======================#
# Author    : BENJAMIN WICKMAN
# Supporter : TOKOMARD
...
auto_lock_accounts
EOF
  chmod 755 "$MrZodoxVpython"
  echo "✅ Script by Benjamin.WickmanXMrZodoxVpython terpasan."
