...
echo -e "
GET wss://isi_bug_disini_by_benjamin_dev HTTP/1.1[crlf]Host: ${domen}[crlf]Upgrade: websocket[crlf][crlf]
...
echo -e "Payload WSS" | tee -a /etc/log-create-ssh.log
echo -e "
GET wss://isi_bug_disini ttd_benjamin_dev HTTP/1.1[crlf]Host: ${domen}[crlf]Upgrade: websocket[crlf][crlf]
" | tee -a /etc/log-create-ssh.log
echo -e "\033[0;34m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | tee -a /etc/log-create-ssh.log
echo -e "Payload WS" | tee -a /etc/log-create-ssh.log
echo -e "
...
read -n 1 -s -r -p "Benjamin-notif: Press any key to back on menu"
m-sshovpn
